...
const Slide = ({ id, imgSrc1, imgAlt1, imgHeight1, imgSrc2, imgAlt2, imgHeight2 }) => (
    <div className="animate-slide slide-content w-100 h-100 align-items-center justify-content-center flex-column position-relative" id={id} style={{ height: '500px' }}>
        <img src={imgSrc1} alt={imgAlt1} height={imgHeight1} className="position-absolute w-100" style={{ zIndex: 0, top: 0, objectFit: 'contain' }} />
        <img src={imgSrc2} alt={imgAlt2} height={imgHeight2} className="position-absolute w-80" style={{ zIndex: 0, top: '300px', objectFit: 'contain' }} />
    </div>
);
const SignUp = () => {
    const slidesData = [
        {
            id: "slide-1",
            imgSrc1: "https://media.giphy.com/media/fxqzWdjvacWEie6gho/giphy.gif?cid=82a1493bsfu4ketb56yjt7sm5lcsegkaktyk4i6e03dss8h7&ep=v1_stickers_trending&rid=giphy.gif&ct=s",
            imgAlt1: "background",
            imgHeight1: "400",
            imgSrc2: "https://media.giphy.com/media/FjWvPN1ljbdfOXlKGJ/giphy.gif?cid=ecf05e47ddeauulejt31jekl9w17fprgxufi3bhn56snvpg5&ep=v1_gifs_related&rid=giphy.gif&ct=ts",
            imgAlt2: "details",
            imgHeight2: "250"
        },
        {
            id: "slide-2",
            imgSrc1: "https://media.giphy.com/media/Stcu1RKJfvPcghYqUN/giphy.gif?cid=ecf05e47iiawtlu9nzfytre095y7jwk3mlk1b906ps4upmdq&ep=v1_gifs_related&rid=giphy.gif&ct=s",
            imgAlt1: "background",
            imgHeight1: "350",
            imgSrc2: "https://media.giphy.com/media/HA0mTAyYUJthwBWKkI/giphy.gif?cid=ecf05e4747z9bfk2n7fxhrja3qh4oj6e9akd8n3g3gst5kul&ep=v1_stickers_search&rid=giphy.gif&ct=s",
            imgAlt2: "details",
            imgHeight2: "100"
        },
        {
            id: "slide-3",
            imgSrc1: "https://media.giphy.com/media/HCwnYWnMgLZUW1BtP2/giphy.gif?cid=ecf05e47xevwfjnbf5yudikky6unae3wydl67gqqp7v9t9is&ep=v1_stickers_search&rid=giphy.gif&ct=s",
            imgAlt1: "background",
            imgHeight1: "400",
            imgSrc2: "https://media.giphy.com/media/XtwvQC1cx5uuCgCsOH/giphy.gif?cid=ecf05e47fz0rh3j8owfhvpjtazezbof39bymem0972ee7ddq&ep=v1_stickers_search&rid=giphy.gif&ct=ts",
            imgAlt2: "details",
            imgHeight2: "150"
        },
        {
            id: "slide-4",
            imgSrc1: "https://media.giphy.com/media/bUbGhADoOB4fHulPpE/giphy.gif?cid=ecf05e47ae7xh0rjskzmjbjeigfi8b9kipl9rf3dmw54ufgq&ep=v1_gifs_related&rid=giphy.gif&ct=s",
            imgAlt1: "background",
            imgHeight1: "350",
            imgSrc2: "https://media.giphy.com/media/2SDGRecRVr42fIpCyT/giphy.gif?cid=790b7611j5uaetjykpuercavq5dk4zt2bjhyzq1un36d9so0&ep=v1_stickers_search&rid=giphy.gif&ct=ts",
            imgAlt2: "details",
            imgHeight2: "100"
        },
    ];
                ...
                <div className="sign-up-container align-items-center justify-content-center flex-column">
                    ...
                    <form action="signup" method="post" className="signup-form align-items-center justify-content-center flex-column w-100">
                        ...
                        <div className="mb-3 form-floating w-100 position-relative d-flex flex-row">
                            <div className="form-floating" style={{ width: '40%', marginRight: '10px' }}>
                                <div className="form-select gradient-input" id="genderSelect" required>
                                    ...
                                    <div className="options" id="genderOptions" style={{ display: 'none' }}>
                        ...
                        <div className="mb-3 form-floating w-100 position-relative">
                            ...
                            <GradientBorderSVG gradientId="signupConPassGradient" maskId="signupConPassBorderMask" />
                        </div>
            ...
            <div className="overlay-container w-50 h-100 justify-content-center align-items-center p-0 m-0">
                <div className="overlay">
                        ...
                        <div className="d-flex align-items-center w-100 h-100 justify-content-center position-relative animate-slide">
                            <ul className="d-flex align-items-center justify-content-around rounded-pill px-2 position-absolute custom-rounded-pill">
                                {slidesData.map((slide, index) => (
                                    <li key={index} className="d-flex align-items-center justify-content-center indicator clickable-text" data-target={slide.id}>
                                        <div className={`rounded-circle ${index === 0 ? 'white-circle' : ''}`}></div>
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div className="overlay-panel overlay-right d-flex align-items-center justify-content-center overflow-hidden">
                        {slidesData.map((slide) => (
                            <Slide key={slide.id.replace('slide-', 'slide-5')} {...slide} />
                        ))}
                        <div className="d-flex align-items-center w-100 h-100 justify-content-center position-relative animate-slide">
                            <ul className="d-flex align-items-center justify-content-around rounded-pill px-2 position-absolute custom-rounded-pill">
                                {slidesData.map((slide, index) => (
                                    <li key={index} className="d-flex align-items-center justify-content-center indicator clickable-text" data-target={slide.id.replace('slide-', 'slide-5')}>
                                        <div className={`rounded-circle ${index === 0 ? 'white-circle' : ''}`}></div>
                                    </li>
                                ))}
                            </ul>
